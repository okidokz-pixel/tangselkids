...
import { swimmingPools, placeMatchesAreas } from "@/lib/mockData";
        ...
        <div style={{ position: "fixed", bottom: 0, left: 0, right: 0, zIndex: 10,
          ...
          <div style={{ maxWidth: 448, margin: "0 auto" }}>
            <button
              ...
              {tier === "guest" ? "Daftar untuk Lihat Semua" : t.poolShowResults(filtered.length)}
            </button>
          </div>
        </div>
      </div>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            ...
            <div>
              ...
              <p style={{ margin: "3px 0 0", color: "rgba(255,255,255,0.6)", fontSize: 12 }}>
                {t.poolShowResults(filtered.length)}
              </p>
            </div>
          </div>
          <PremiumBadge />
