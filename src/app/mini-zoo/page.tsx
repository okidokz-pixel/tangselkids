...
function MiniZooContent() {
  ...
  useEffect(() => {
    fetchPlacesByCategory("mini-zoo").then(d => {
      setAllPlaces(d);
  ...
  function goCompare() {
    if (typeof window !== "undefined") localStorage.setItem("compareMiniZooIds", JSON.stringify(compareIds));
    window.location.href = "/compare?type=minizoo";
  }
