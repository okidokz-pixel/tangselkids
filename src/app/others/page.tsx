...
import { othersPlaces, placeMatchesAreas } from "@/lib/mockData";
        ...
        <div style={{ position: "fixed", bottom: 0, left: 0, right: 0, zIndex: 10,
          ...
          <div style={{ maxWidth: 448, margin: "0 auto" }}>
            <button
              ...
              {tier === "guest" ? "Daftar untuk Lihat Semua" : t.othersShowResults(filtered.length)}
            </button>
          </div>
        </div>
      </div>
